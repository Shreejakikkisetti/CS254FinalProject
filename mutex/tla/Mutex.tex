...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} Mutex}\moduleRightDash\@xx{}%
...
\@x{\@s{16.4} pc ,\,\@s{17.60}}%
\@y{\@s{0}%
 Program counter for each process (noncritical, trying, critical)
}%
\@xx{}%
\@x{\@s{16.4} lock ,\,\@s{9.94}}%
\@y{\@s{0}%
 Lock state (FREE or process id that holds it)
}%
\@xx{}%
\@x{\@s{16.4} queue\@s{8.20}}%
\@y{\@s{0}%
 Sequence of processes waiting for the lock
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} pc ,\, lock ,\, queue {\rangle}}%
\@pvspace{8.0pt}%
\@x{ States \.{\defeq} \{\@w{noncritical} ,\,\@w{trying} ,\,\@w{critical} \}}%
...
\@xx{}%
 \@x{ InQueue ( p ) \.{\defeq} \E\, i \.{\in} 1 \.{\dotdot} Len ( queue )
 \.{:} queue [ i ] \.{=} p}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} pc \.{\in} [ Procs \.{\rightarrow} States ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} lock \.{\in} \{ 0 \} \.{\cup} Procs\@s{4.1}}%
\@y{\@s{0}%
 0 means FREE
}%
\@xx{}%
\@x{\@s{16.4} \.{\land}\@s{9.74} queue \.{\in} Seq ( Procs )\@s{20.5}}%
\@y{\@s{0}%
 Queue is a sequence of process \ensuremath{IDs
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} pc \.{=} [ p \.{\in} Procs
 \.{\mapsto}\@w{noncritical} ]}%
\@x{\@s{16.4} \.{\land} lock \.{=} 0}%
\@x{\@s{16.4} \.{\land} queue \.{=} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 Empty sequence
}%
\@xx{}%
...
\@xx{}%
\@x{ Try ( p ) \.{\defeq}}%
\@x{\@s{20.23} \.{\land} pc [ p ] \.{=}\@w{noncritical}}%
\@x{\@s{20.23} \.{\land} {\lnot} InQueue ( p )\@s{4.1}}%
\@y{\@s{0}%
 Not already in queue
}%
\@xx{}%
 \@x{\@s{20.23} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{trying} ]}%
\@x{\@s{20.23} \.{\land} queue \.{'} \.{=} Append ( queue ,\, p )\@s{4.1}}%
\@y{\@s{0}%
 Add to end of queue
}%
\@xx{}%
\@x{\@s{20.23} \.{\land} {\UNCHANGED} lock}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Enter ( p ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} pc [ p ] \.{=}\@w{trying}}%
\@x{\@s{16.4} \.{\land} lock \.{=} 0}%
\@x{\@s{16.4} \.{\land} Len ( queue ) \.{>} 0\@s{4.1}}%
\@y{\@s{0}%
 Queue not empty
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} Head ( queue ) \.{=} p\@s{4.1}}%
\@y{\@s{0}%
 Must be first in queue
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} lock \.{'} \.{=} p}%
\@x{\@s{16.4} \.{\land} queue \.{'} \.{=} Tail ( queue )\@s{4.1}}%
\@y{\@s{0}%
 Remove from front of queue
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{critical} ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Exit ( p ) \.{\defeq}}%
\@x{\@s{18.75} \.{\land} pc [ p ] \.{=}\@w{critical}}%
\@x{\@s{18.75} \.{\land} lock \.{=} p}%
\@x{\@s{18.75} \.{\land} lock \.{'} \.{=} 0}%
 \@x{\@s{18.75} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{noncritical} ]}%
\@x{\@s{18.75} \.{\land} {\UNCHANGED} queue}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 System transitions
...
\@xx{}%
 \@x{ Next \.{\defeq} \E\, p \.{\in} Procs \.{:} Try ( p ) \.{\lor} Enter ( p
 ) \.{\lor} Exit ( p )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Fairness \.{\defeq} \A\, p \.{\in} Procs \.{:}}%
\@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( Try ( p ) )}%
\@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( Enter ( p ) )}%
\@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( Exit ( p ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@x{\@s{16.4} \A\, p1 ,\, p2 \.{\in} Procs \.{:}}%
 \@x{\@s{27.72} ( p1 \.{\neq} p2 ) \.{\implies} {\lnot} ( pc [ p1 ]
 \.{=}\@w{critical} \.{\land} pc [ p2 ] \.{=}\@w{critical} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Liveness \.{\defeq}}%
 \@x{\@s{16.4} \A\, p \.{\in} Procs \.{:} ( pc [ p ] \.{=}\@w{trying} )
 \.{\leadsto} ( pc [ p ] \.{=}\@w{critical} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ NoStarvation \.{\defeq}}%
 \@x{\@s{16.4} \A\, p \.{\in} Procs \.{:} InQueue ( p ) \.{\leadsto} ( pc [ p
 ] \.{=}\@w{critical} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ Spec \.{\defeq} Init \.{\land}\@s{15.56} {\Box} [ Next ]_{ vars}
 \.{\land} Fairness}%
\@pvspace{8.0pt}%
