...
\@x{ {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} MaxFloors ,\,\@s{12.29}}%
\@y{\@s{0}%
 Total number of floors in building
}%
\@xx{}%
\@x{\@s{54.75} Ascending ,\,\@s{13.81}}%
\@y{\@s{0}%
 Upward movement state
}%
\@xx{}%
\@x{\@s{54.75} Descending\@s{15.21}}%
\@y{\@s{0}%
 Downward movement state
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} MaxFloors \.{\in} Nat\@s{4.1}}%
\@y{\@s{0}%
 Must be a natural number
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} position ,\,\@s{16.59}}%
\@y{\@s{0}%
 Current position (odd \ensuremath{\.{=}} at floor, even \ensuremath{\.{=}}
 between floors)
}%
\@xx{}%
\@x{\@s{51.42} movement\@s{12.30}}%
\@y{\@s{0}%
 Current movement state (Ascending or \ensuremath{Descending})
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@xx{}%
\@x{ AtFloor ( floor ) \.{\defeq} position \.{=} 2 \.{*} floor \.{-} 1}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ InTransit \.{\defeq} position \.{\%} 2 \.{=} 0}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Init \.{\defeq} \.{\land} position\@s{10.40} \.{=} 1}%
\@x{\@s{35.70} \.{\land} movement \.{\in} \{ Ascending ,\, Descending \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ StartAscending \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \E\, f \.{\in} 1 \.{\dotdot} MaxFloors\@s{5.89} \.{-}
 1 \.{:} AtFloor ( f )\@s{4.1}}%
\@y{\@s{0}%
 At any floor except top
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} position \.{'}\@s{10.40} \.{=} position \.{+}
 1\@s{4.1}}%
\@y{\@s{0}%
 Move to in-between state
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} movement \.{'} \.{=} Ascending}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ContinueAscending \.{\defeq}}%
\@x{\@s{16.4} \.{\land} InTransit\@s{4.1}}%
\@y{\@s{0}%
 Must be between floors
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} movement \.{=} Ascending}%
\@x{\@s{16.4} \.{\land} position \.{'} \.{=} position \.{+} 1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} movement}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ StartDescending \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} \E\, f \.{\in} 2 \.{\dotdot} MaxFloors \.{:} AtFloor
 ( f )\@s{4.1}}%
\@y{\@s{0}%
 At any floor except bottom
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} position \.{'}\@s{10.40} \.{=} position \.{-} 1}%
\@x{\@s{16.4} \.{\land} movement \.{'} \.{=} Descending}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ContinueDescending \.{\defeq}}%
\@x{\@s{16.4} \.{\land} InTransit}%
\@x{\@s{16.4} \.{\land} movement \.{=} Descending}%
\@x{\@s{16.4} \.{\land} position \.{'} \.{=} position \.{-} 1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} movement}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ Next \.{\defeq} \.{\lor} StartAscending}%
\@x{\@s{39.83} \.{\lor} ContinueAscending}%
\@x{\@s{39.83} \.{\lor} StartDescending}%
\@x{\@s{39.83} \.{\lor} ContinueDescending}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ vars \.{\defeq} {\langle} position ,\, movement {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ Fairness \.{\defeq}}%
\@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( ContinueAscending )\@s{4.1}}%
\@y{\@s{0}%
 Must complete in-progress movements
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( ContinueDescending )}%
 \@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( StartAscending \.{\land} AtFloor ( 1
 ) )\@s{4.1}}%
\@y{\@s{0}%
 Must move from terminal floors
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} {\WF}_{ vars} ( StartDescending \.{\land} AtFloor (
 MaxFloors ) )}%
 \@x{\@s{16.4} \.{\land} \A\, f \.{\in} 2 \.{\dotdot} MaxFloors \.{-} 1
 \.{:}\@s{4.1}}%
\@y{\@s{0}%
 Must eventually move from middle floors
}%
\@xx{}%
 \@x{\@s{31.61} \.{\land} {\SF}_{ vars} ( StartAscending \.{\land} AtFloor ( f
 ) )}%
 \@x{\@s{31.61} \.{\land} {\SF}_{ vars} ( StartDescending \.{\land} AtFloor (
 f ) )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
