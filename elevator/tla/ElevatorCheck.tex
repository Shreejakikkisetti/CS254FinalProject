...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} ElevatorCheck}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} elevator}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ StateView \.{\defeq} [}%
\@x{\@s{16.4} pos \.{\mapsto} position ,\,}%
 \@x{\@s{16.4} currentFloor \.{\mapsto} {\IF} InTransit \.{\THEN}\@w{between}
 \.{\ELSE} ( position \.{+} 1 ) \.{\div} 2 ,\,}%
\@x{\@s{16.4} dir \.{\mapsto} movement}%
\@x{ ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ ValidBounds \.{\defeq} \.{\land} position \.{\geq} 0}%
\@x{\@s{74.55} \.{\land} position \.{\leq} 2 \.{*} MaxFloors \.{-} 1}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Liveness: Elevator doesn\mbox{'}t get permanently stuck between floors
}%
\@xx{}%
\@x{ StuckInTransit \.{\defeq} {\Diamond} {\Box} ( InTransit )}%
\@x{ NoStuck \.{\defeq} {\lnot} StuckInTransit}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ ReachesAllFloors \.{\defeq} {\Box} \A\, f \.{\in} 1 \.{\dotdot}
 MaxFloors \.{:} {\Diamond} ( AtFloor ( f ) )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
